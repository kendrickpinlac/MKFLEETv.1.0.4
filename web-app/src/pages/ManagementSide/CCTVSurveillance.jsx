...
import CCTVSurveillanceComponent from '../../components/ManagementSide/CCTVSurveillanceComponent';
import Header from '../../components/ManagementSide/Header';
import Footer from '../../components/ManagementSide/Footer';

const CCTVSurveillancePage = () => {
  return (
...
export default CCTVSurveillancePage;
